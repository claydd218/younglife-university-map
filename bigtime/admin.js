...
// --- Area name fuzzy matching ----------------------------------------------
// Shared by the Ministry dialog's own duplicate-area check (checkForExisting
// Area, further up) — city spellings drift ("Nielles-lès-Ardres" vs "Nielles
// les Ardres"), so an exact-match-first, closest-edit-distance-second lookup
// catches likely dupes a plain string comparison would miss.
